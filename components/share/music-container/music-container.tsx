...
const MusicContainer = ({ children, className = "" }: MusicContainerImpl) => {
  return (
    <>
      <div
      ...
      >
        <ShadowBorder />
        <div className="flex rounded-2xl h-full w-full items-center justify-start flex-col p-3 relative bg-one-dark z-50">
          {children}
        </div>
      </div>
    </>
